    ...
    return (
        <div>
            <footer className='border-t py-12'>
                <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 lg:px-0 px-4'>
                    <div>
                        ...
                        {/*News letter form */}
                        <form className="flex">
                            <input type="email" className='p-3 w-full text-sm border-t border-l border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all' placeholder='Enter your email' required />
                ...
                <div className='container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6'>
                    <p className='text-gray-500 text-sm tracking-tighter text-center'>@ 2025, E-Cart. All rights reserverd.</p>
